...
Classic
=======
Prior to version 3, RPyC-NG employed a modus-operandi that's now referred to as
...
Starting with version 3, RPyC-NG became *service-oriented*, and now servers expose
...
Usage
-----
RPyC-NG installs ``rpyc_classic.py`` to your Python scripts directory (e.g., ``C:\PythonXX\Scripts``,
